...
export class GesturePipeline {
  ...
  private histories = new Map<number, TrailHistory>();

  private onGesture?: (trail: GestureTrail) => void;

  async initialize(
    video: HTMLVideoElement,
    gestureHandler: (trail: GestureTrail) => void
  ) {
    try {
  ...
  private emitGesture(trail: GestureTrail) {
